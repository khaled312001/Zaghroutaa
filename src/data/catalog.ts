...
export const PRODUCTS: ProductMeta[] = [
  ...
  /* ----------------------------- إضافات حديثة ----------------------------- */
  {
    slug: "macrame-curtain",
    nameAr: "ستارة مكرمية ١٠٠ سم",
    categorySlug: "macrame",
    basePrice: 900,
    shortAr: "ستارة/معلّقة حائط مكرمية هاند ميد مقاس ١٠٠ سم.",
    descriptionAr:
      "ستارة أو معلّقة حائط مكرمية هاند ميد مقاس ١٠٠ سم بخيوط القطن الطبيعي وتصميم بوهيمي غني بالتفاصيل — قطعة بتغيّر شكل أي حائط.",
    isFeatured: true,
    order: 32,
  },
  {
    ...
    categorySlug: "macrame",
    basePrice: 350,
    shortAr: "مخدة مكرمية هاند ميد بتصميم متشابك فخم.",
    descriptionAr:
      "مخدة مكرمية هاند ميد بتصميم متشابك فخم — تضيف لمسة بوهيمية دافئة للكنبة والسرير. متاحة بالقطعة أو طقم ٤ قطع بسعر مميز.",
    variants: [
      { nameAr: "القطعة", price: 350 },
      { nameAr: "٤ قطع مع بعض", price: 1000 },
    ],
    order: 33,
  },
  {
    slug: "macrame-keychain-rainbow",
    nameAr: "ميدالية مكرمية قوس قزح",
    categorySlug: "macrame",
    basePrice: 70,
    shortAr: "ميدالية مفاتيح مكرمية بشكل قوس قزح وألوان مبهجة.",
    descriptionAr:
      "ميدالية مفاتيح مكرمية هاند ميد بشكل قوس قزح وألوان مبهجة وشراشيب ناعمة — هدية لطيفة وتوزيعة حلوة. متاحة بالقطعة أو الاتنين.",
    variants: [
      { nameAr: "القطعة", price: 70 },
      { nameAr: "الاتنين مع بعض", price: 100 },
    ],
    order: 34,
  },
  {
    slug: "embroidered-caps",
    nameAr: "كاب مطرّز هاند ميد",
    categorySlug: "accessories",
    basePrice: 200,
    shortAr: "كاب قطن مطرّز بإيد بالورد، شيك للخروج والصيف.",
    descriptionAr:
      "كاب قطن مطرّز بإيد بالورد والتفاصيل اللطيفة — شيك ومريح للخروج والصيف، ويتعمل بالاسم أو التصميم اللي تحبيه. متاح فردي أو اتنين.",
    variants: [
      { nameAr: "القطعة", price: 200 },
      { nameAr: "الاتنين مع بعض", price: 300 },
    ],
    order: 35,
  },
  {
    slug: "katb-ketab-handkerchief-lolly",
    nameAr: "منديل كتب كتاب هاند ميد لولي",
    categorySlug: "handkerchiefs",
    basePrice: 650,
    shortAr: "منديل كتب كتاب هاند ميد مطرّز بالاسم والتاريخ بلمسة ذهبية ولؤلؤ.",
    descriptionAr:
      "منديل كتب كتاب هاند ميد مطرّز باسم العروسين وتاريخ كتب الكتاب بالخرز واللؤلؤ والورد واللمسة الذهبية — تشطيب لولي وراقي يفضل ذكرى العمر.",
    badge: "هاند ميد",
    order: 36,
  },
];
